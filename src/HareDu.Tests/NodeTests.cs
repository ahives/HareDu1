namespace HareDu.Tests
{
        ...
        HareDuTesting
    {
        ...
        public void Should_be_able_to_get_all_nodes()
        {
            ...
            result.Data[0].ContextSwitchDetails.Value.ShouldBe(32.4M);
            ...
            result.Data[0].GcDetails.Value.ShouldBe(6.0M);
            ...
            result.Data[0].MemoryUsageDetails.Value.ShouldBe(20480.0M);
            result.Data[0].SocketsUsed.ShouldBe<ulong>(1);
            result.Data[0].SocketsUsedDetails.ShouldNotBeNull();
            result.Data[0].SocketsUsedDetails.Value.ShouldBe(0.0M);
            ...
            result.Data[0].FreeDiskSpaceDetails.Value.ShouldBe(0.0M);
            result.Data[0].FileDescriptorUsed.ShouldBe<ulong>(0);
            result.Data[0].FileDescriptorUsedDetails.ShouldNotBeNull();
            result.Data[0].FileDescriptorUsedDetails.Value.ShouldBe(0.0M);
            ...
            result.Data[0].MnesiaDiskTransactionCountDetails.Value.ShouldBe(0.0M);
            ...
            result.Data[0].FileHandleOpenAttemptDetails.Value.ShouldBe(0.0M);
